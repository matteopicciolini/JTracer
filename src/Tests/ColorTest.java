...
class ColorTest {
    ...
    void sum() {
        ...
        Assertions.assertTrue(sum.isClose(color1.sum(color2)));
    }
    @Test
    void prod() {
        ...
        Assertions.assertTrue(color_prod_exact.isClose(color_prod));
    }
    ...
    void testProd () {
        ...
        Assertions.assertTrue(color_prod.isClose(color_exact));
    }
    ...
    void difference () {
        ...
        Assertions.assertTrue(color_diff.isClose(color_diff_exact));
    }
    ...
    void is_close () {
        Color color1 = new Color(1.0f, 2.0f, 3.0f);
        Color color2 = new Color(2.0f, 3.0f, 4.0f);
        Assertions.assertFalse(color1.isClose(color2));
    }
